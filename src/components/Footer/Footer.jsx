...
import { FaFacebook, FaTwitter, FaLinkedin, FaInstagram, FaYoutube, FaEnvelope, FaPhone  } from "react-icons/fa";
  ...
  return (
    <footer className="text-white py-8 px-[12vw] md:px-[7vw] lg:px-[20vw]">
      <div className="container mx-auto text-center">
        {/* Name / Logo */}
        <h2 className="text-xl font-semibold text-purple-500">Sulvin Varghese</h2>
        ...
        <p className="text-sm text-gray-400 mt-6">
          © 2025 Sulvin Varghese. All rights reserved.
        </p>
      </div>
    </footer>
  );
